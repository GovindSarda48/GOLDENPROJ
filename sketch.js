...
if(isTouchingC(farmer,clue1)){
  open++; 
  clue1b.show(); 
  clue1b.position(displayWidth/2-50,displayHeight/4); // console.log(open); //Matter.Body.setStatic(farmer.body,true);
}
...
/*clue1b.mousePressed(function(){ 
  if(clueCount===0){
     clue1b.hide(); 
     console.log(clueCount) //gameState="clue1"; //1 //clueCount 1 is for opening clue 1; clueCount+=1;//1 
} })*/
